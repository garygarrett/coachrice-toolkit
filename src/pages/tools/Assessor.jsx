  ...
  const recomputeScores = (rawEval) => {
    ...
    return {
      ...
      score_calculation: {
        ...
        result: (finalScore >= 3.4 && rawEval.ethical_practice?.icf_code_alignment === 'Observed' && rawEval.ethical_practice?.coach_role_alignment === 'Observed') ? "Pass" : "Below Passing Standard",
      },
    };
  };
