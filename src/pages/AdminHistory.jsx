...
export default function AdminHistory() {
  ...
  function downloadAssessmentPDF(assessment) {
    ...
    const behavioralStatementsHTML = [3, 4, 5, 6, 7, 8].map((comp) => {
    ...
    const strengthsHTML = evaluation.strengths && evaluation.strengths.length > 0 ? `
      <section>
        <div class="section-header">
    ...
    const suggestionsHTML = evaluation.suggestions && evaluation.suggestions.length > 0 ? `
      <section>
        <div class="section-header">
    ...
    const scoreTableHTML = evaluation.score_calculation ? `
      <section>
        <div class="section-header">
